...
# Function to read the first dataset (avg_z vs avg_l)
...
def read_and_plot_data(file_path1, file_path2):
    ...
    plt.legend(loc='upper right', bbox_to_anchor=(1, 1), fontsize=18, frameon=True)

    plt.tight_layout()

    plt.savefig(
        'a1a2b1_a1a2b2_b1b2a1_b1b2a2_correct_DGT_-4_30june.png',
        dpi=300,
        bbox_inches='tight'
    )
