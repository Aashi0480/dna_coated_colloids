...
def main():
    file_path = 'long_Gillespie_BD_negno_test18_AB_DGT-2_DG_-20_rho_ideal_1.0e-05_1000_modified.dump'
    #fields_to_save = ["a1a2", "a2a1", "a1b1", "a2b2", "b1b2", "b2b1",
                      #"a1a2b1", "a1a2b2", "b1b2a1", "b1b2a2"]
    
    fields_to_save = [["a1a2b1", "a1a2b2", "sur_3sbrg"]]
    ...
    for field in fields_to_save:
        ...
        output_file = f"a1a2b1_a1a2b2_averages.txt"
