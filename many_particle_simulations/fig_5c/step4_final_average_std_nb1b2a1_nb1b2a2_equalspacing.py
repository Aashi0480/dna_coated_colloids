...
def process_file(file_path, output_file):
    ...
    data["b1b2a1_b1b2a2"] = pd.to_numeric(data["b1b2a1_b1b2a2"], errors="coerce")
    ...
    # Replace NaN std (single element groups)
    result["std_z"] = result["std_z"].fillna(0)
    result["std_b1b2a1_b1b2a2"] = result["std_b1b2a1_b1b2a2"].fillna(0)

    # Calculate error bars
    result["err_z"] = result["std_z"] / np.sqrt(N)
    result["err_b1b2a1_b1b2a2"] = result["std_b1b2a1_b1b2a2"] / np.sqrt(N)
