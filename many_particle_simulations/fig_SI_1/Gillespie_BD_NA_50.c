...
{   
    ...
    ofstream myfile1;
    ofstream myfile2;
    myfile1.open ("long_Gillespie_BD_negno_test18_AB_DGT-2_DG_-20_rho_ideal_1.0e-05_1000_Na50_modified.dump");
...
/***********Particle position *************************************/
    ...
    for (i=0; i<Np; i++) ////commemnted out for timew being
    {
        if(P[i].type==0)
        {
            P[i].Pn[i].nl_a1a2=50.0;
            P[i].nf_a1=0.0;
            P[i].nf_a2=0.0;
        }
        if(P[i].type==1)
        {
            P[i].Pn[i].nl_b1b2=50.0;
            P[i].nf_b1=0.0;
            P[i].nf_b2=0.0;
        }
    }
...
/********Force Calculations************************************************************************/
        ...
        if (P[i].type==0)
        {
            if (P[i].tot_a1 != 50 || P[i].tot_a2 != 50)
            {
        ...
        if (P[i].type==1)
        {
            if (P[i].tot_b1 != 50 || P[i].tot_b2 != 50)
            {
