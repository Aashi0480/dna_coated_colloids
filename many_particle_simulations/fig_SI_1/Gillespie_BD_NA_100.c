...
{   
    ...
    ofstream myfile1;
    ofstream myfile2;
    myfile1.open ("long_Gillespie_BD_negno_test18_AB_DGT-2_DG_-20_rho_ideal_1.0e-05_1000_Na100_modified.dump");
...
/***********Particle position *************************************/
    ...
    for (i=0; i<Np; i++) ////commemnted out for timew being
    {
        if(P[i].type==0)
        {
            P[i].Pn[i].nl_a1a2=100.0;
            P[i].nf_a1=0.0;
            P[i].nf_a2=0.0;
        }
        if(P[i].type==1)
        {
            P[i].Pn[i].nl_b1b2=100.0;
            P[i].nf_b1=0.0;
            P[i].nf_b2=0.0;
        }
    }
...
/********Force Calculations************************************************************************/
                ...
                if (count_deposition_ne==Np && m_test==0)
                {
                    ...
                    if (insertion_prob > insertion_rand)
                    {
                        ...
                        if (P[i_new].type == 0)
                        {
                            ...
                            P[i_new].nf_b1=0;
                            P[i_new].nf_b2=0;
                            P[i_new].Pn[i_new].nl_a1a2=100.0;
                            P[i_new].nbS_a1C=0.0;
                        ...
                        if (P[i_new].type == 1)
                        {
                            ...
                            P[i_new].nf_b1=0;
                            P[i_new].nf_b2=0;
                            P[i_new].Pn[i_new].nl_b1b2=100.0;
                            P[i_new].nbS_b2C=0.0;
                        }
                    }
                    else
        ...
        if (P[i].type==0)
        {
            if (P[i].tot_a1 != 100 || P[i].tot_a2 != 100)
            {
        ...
        if (P[i].type==1)
        {
            if (P[i].tot_b1 != 100 || P[i].tot_b2 != 100)
            {
