...
int main()
{
    ...
    ofstream myfile1;
    ofstream myfile2;
    myfile1.open ("k0k1_blue_clean_17.2.dump");
...
/**************************************  Data saved  ****************************/
        ...
        myfile1 << "ITEM: ATOMS type id x y z Fx Fy Fz nbS nl 2sa1 2sa2 3sa1 3sa2 2sb1 2sb2 3sb1 3sb2 nb3s nn nfa1 nfa2 nfb1 nfb2 lfbs nfS_C omega_i" <<  endl;
