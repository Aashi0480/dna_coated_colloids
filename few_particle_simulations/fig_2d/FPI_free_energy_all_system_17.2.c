...
int main()
{
    ...
    FILE *in;
    FILE *out;
    in=fopen("k0k1_blue_clean_17.2.dump","r");

    {
        ...
        F_i_bb=NL*log(free_b1_2*free_b2_2/SQ(NL))+nl_2;
        F_i_sa=nbs_1+2*A3S_surface_1;
        F_ij_ab=a1s2_1+a2s2_1+2*nb3s_1;
        F = F_i_ss + F_i_aa_1 + F_i_bb + F_i_sa + F_ij_ab - F_gas ;
